...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageQuestion.aspx.cs" Inherits="WebTests.PageQuestion" %>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            object.onchange = function () {
                ...
                window.location.href = 'PageQuestion.aspx?testId=' + testId + '&questId=' + questId;
            };
        }
            ...
            <div class="clear hideSkiplink">
                <asp:Menu ID="NavigationMenu" runat="server" CssClass="menu" EnableViewState="false"
                    ...
                    <Items>
                        ...
                        <asp:MenuItem NavigateUrl="~/OTPB.aspx" Text="Choose another test" />
                    </Items>
                </asp:Menu>
            </div>
        </div>
...
StartValue="#FF0000" EndValue="#00FFFF" />
         ...
         <%-- <FadeIn Duration=".5" Fps="25" />--%>
            ...
            <div class="myframe" style="width: 120px;">
                <asp:ListBox ID="QuestionsPerPart" CssClass="hand" runat="server" Style="font-weight: bold;
                    height: 500px; border: none;"></asp:ListBox>
            </div>
