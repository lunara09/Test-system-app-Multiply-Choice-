...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamQuestion.aspx.cs" Inherits="WebTests.ExamQuestion" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        window.onload = function () {
            ...
            object.onchange = function () {
                ...
                window.location.href = 'ExamQuestion.aspx?testId=' + testId + '&questId=' + questId;
            };
        }
        ...
        <div class="page">
            ...
            <div class="title">
                    <p>
                       <img src="images/logo.png" height="60px" />     
                        <asp:Label runat="server" ID="lblUserName" />, Exam:
                ...
                <div class="clear hideSkiplink">
                    <asp:Menu ID="NavigationMenu" runat="server" CssClass="menu" EnableViewState="false"
                        ...
                        <Items>
                            ...
                            <asp:MenuItem NavigateUrl="~/ListExam.aspx" Text="Choose another test" />
            ...
            <div class="main">
                ...
                <div class="myframe" style="width: 120px;">
                    <asp:ListBox ID="QuestionsPerPart" runat="server" Style="font-weight: bold; height: 500px; border: none; overflow: auto;"></asp:ListBox>
                </div>
                ...
                Prior to the completion of exams left<br />
                 ...
                 <ContentTemplate>
                  <asp:Button ID="AnswerButton" runat="server" Style="font-weight: bold; cursor:pointer;" OnClick="AnswerOnQuestion" Visible="true" Enabled="false" Text="Submit"/>       
